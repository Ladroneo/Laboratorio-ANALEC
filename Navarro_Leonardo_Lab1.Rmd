...
vxp %>% 
  slice(which.max(Votos),
        which.min(Votos))
```
El partido con mayor cantidad de votos válidos corresponde al Partido Republicano de Chile, con 3.476.333. Mientras que el partido con menor cantidad de vótos válidos corresponde a Acción Humanista con 3.073 votos.
